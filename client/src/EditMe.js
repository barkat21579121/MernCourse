...
export let navigation = {
  navLogo: {
    ...
    imageURL:
      "https://www.wilsonfamilychiropracticcenter.net/wp-content/uploads/2018/12/placeholder-logo-2.png",
  ...
  leftNavigation: [
    // Add items to the left side of the navigation Bar
    {
      text: "_External",
      url: "#",
    },
  ...
  rightNavigation: [
    // Add items to the right side of the navigation Bar
    {
...
export let experience = {
  experiences: [
    // Preferably, sort by newest first
    {
...
export let skills = {
  ...
  skillsData: [
    ...
    // Some examples are shown below
    {
      ...
      experience: "3 years",
      description:
        "Built multiple ReactJS based websites with integration of NodeJS and Redux",
    },
    {
      title: "Java",
      value: 25,
      ...
      experience: "2 years",
      description:
        "Worked on multiple Minecraft Plugins and Text-Based Adventure Survival CLI game",
    },
    {
      title: "C++",
      value: 10,
    ...
    },
    {
      ...
      experience: "1 year",
      description:
        "Experience with Game Development such as Unity (C#) having 2 published games on the Play Store.",
    },
  ],
};
